-- Schema for recipes app (MySQL)
-- Run: mysql -u root -p < recipes_schema.sql

CREATE DATABASE IF NOT EXISTS pku_recipes CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE pku_recipes;
...
-- Join table: many-to-many recipes <-> tags
